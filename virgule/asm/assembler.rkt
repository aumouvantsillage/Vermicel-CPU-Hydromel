...
(define (LUI   rd  imm)         (fields->word  opcode_lui                            #:rd rd                     #:imm imm))
(define (AUIPC rd  imm)         (fields->word  opcode_auipc                          #:rd rd                     #:imm imm))
(define (JAL   rd  offset)      (fields->word* opcode_jal                            #:rd rd                     #:imm offset))
(define (JALR  rd  rs1 offset)  (fields->word* opcode_jalr   #:funct3 funct3_jalr    #:rd rd #:rs1 rs1           #:imm offset))
(define (BEQ   rs1 rs2 offset)  (fields->word* opcode_branch #:funct3 funct3_beq             #:rs1 rs1 #:rs2 rs2 #:imm offset))
(define (BNE   rs1 rs2 offset)  (fields->word* opcode_branch #:funct3 funct3_bne             #:rs1 rs1 #:rs2 rs2 #:imm offset))
(define (BLT   rs1 rs2 offset)  (fields->word* opcode_branch #:funct3 funct3_blt             #:rs1 rs1 #:rs2 rs2 #:imm offset))
(define (BGE   rs1 rs2 offset)  (fields->word* opcode_branch #:funct3 funct3_bge             #:rs1 rs1 #:rs2 rs2 #:imm offset))
(define (BLTU  rs1 rs2 offset)  (fields->word* opcode_branch #:funct3 funct3_bltu            #:rs1 rs1 #:rs2 rs2 #:imm offset))
(define (BGEU  rs1 rs2 offset)  (fields->word* opcode_branch #:funct3 funct3_bgeu            #:rs1 rs1 #:rs2 rs2 #:imm offset))
(define (LB    rd  rs1 [imm 0]) (fields->word  opcode_load   #:funct3 funct3_lb_sb   #:rd rd #:rs1 rs1           #:imm imm))
(define (LH    rd  rs1 [imm 0]) (fields->word  opcode_load   #:funct3 funct3_lh_sh   #:rd rd #:rs1 rs1           #:imm imm))
(define (LW    rd  rs1 [imm 0]) (fields->word  opcode_load   #:funct3 funct3_lw_sw   #:rd rd #:rs1 rs1           #:imm imm))
(define (LBU   rd  rs1 [imm 0]) (fields->word  opcode_load   #:funct3 funct3_lbu     #:rd rd #:rs1 rs1           #:imm imm))
(define (LHU   rd  rs1 [imm 0]) (fields->word  opcode_load   #:funct3 funct3_lhu     #:rd rd #:rs1 rs1           #:imm imm))
(define (SB    rs2 rs1 [imm 0]) (fields->word  opcode_store  #:funct3 funct3_lb_sb           #:rs1 rs1 #:rs2 rs2 #:imm imm))
(define (SH    rs2 rs1 [imm 0]) (fields->word  opcode_store  #:funct3 funct3_lh_sh           #:rs1 rs1 #:rs2 rs2 #:imm imm))
(define (SW    rs2 rs1 [imm 0]) (fields->word  opcode_store  #:funct3 funct3_lw_sw           #:rs1 rs1 #:rs2 rs2 #:imm imm))
(define (ADDI  rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_add_sub #:rd rd #:rs1 rs1           #:imm imm))
(define (SLLI  rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_sll     #:rd rd #:rs1 rs1           #:imm imm #:funct7 funct7_default))
(define (SLTI  rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_slt     #:rd rd #:rs1 rs1           #:imm imm))
(define (SLTIU rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_sltu    #:rd rd #:rs1 rs1           #:imm imm))
(define (XORI  rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_xor     #:rd rd #:rs1 rs1           #:imm imm))
(define (SRLI  rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_srl_sra #:rd rd #:rs1 rs1           #:imm imm #:funct7 funct7_default))
(define (SRAI  rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_srl_sra #:rd rd #:rs1 rs1           #:imm imm #:funct7 funct7_sub_sra))
(define (ORI   rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_or      #:rd rd #:rs1 rs1           #:imm imm))
(define (ANDI  rd rs1 imm)      (fields->word  opcode_op_imm #:funct3 funct3_and     #:rd rd #:rs1 rs1           #:imm imm))
(define (ADD   rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_add_sub #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_default))
(define (SUB   rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_add_sub #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_sub_sra))
(define (SLL   rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_sll     #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_default))
(define (SLT   rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_slt     #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_default))
(define (SLTU  rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_sltu    #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_default))
(define (XOR   rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_xor     #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_default))
(define (SRL   rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_srl_sra #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_default))
(define (SRA   rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_srl_sra #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_sub_sra))
(define (OR    rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_or      #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_default))
(define (AND   rd rs1 rs2)      (fields->word  opcode_op     #:funct3 funct3_and     #:rd rd #:rs1 rs1 #:rs2 rs2           #:funct7 funct7_default))
(define (MRET)                  (fields->word  opcode_system #:funct3 funct3_mret                                #:imm imm_mret))
...
(define (split-imm imm)
  (define i (signed-slice imm 31 0))
